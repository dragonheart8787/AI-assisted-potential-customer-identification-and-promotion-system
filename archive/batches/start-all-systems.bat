...
:: 啟動HTTP伺服器
start "全系統伺服器" cmd /c "python -m http.server 8000"
...
if "%choice%"=="1" goto all_pages
if "%choice%"=="2" goto main_system
if "%choice%"=="3" goto account_manager
...
echo.
echo 🌐 全系統功能：
echo    - 主系統頁面：完整的推銷系統功能
echo    - 安全帳號管理器：安全地管理您的帳號
echo    - AI聊天測試：與AI推銷助手對話
echo    - 系統測試頁面：全面系統功能測試
echo.
echo 🚀 主系統頁面：
echo    - 完整的推銷系統功能
echo    - 直接帳號控制整合
