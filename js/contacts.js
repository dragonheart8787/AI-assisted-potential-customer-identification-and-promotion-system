/**
 * 取得潛在客戶列表 - 合併 CRM 客戶與社交媒體發現的商家/隱藏客群
    ...
    if (window.crmDatabase) {
        ...
        customers.forEach(c => {
            ...
            prospects.push({
                ...
                website_need_score: c.website_need_score,
                security_need_score: c.security_need_score,
                website_need_reasons: c.website_need_reasons,
                security_need_reasons: c.security_need_reasons,
                lead_score_reasons: c.lead_score_reasons,
                tags: c.tags,
                needType: c.needType,
                urgency: c.urgency,
                avatar: '🏢',
